...
@pytest.mark.devtest
def no_test_day_num_data_points_w_date() -> bool:
...
@pytest.mark.devtest
def no_no_test_apple_stock_daily_price() -> bool:
    print("no_test_apple_stock_daily_price")
...
@pytest.mark.devtest
def no_test_negative_current_price() -> bool:
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
    try:
...
@pytest.mark.devtest
def no_test_apple_stock_close_price_range_str_day() -> bool:
    print("no_test_apple_stock_close_price_range_int_day")
    dl = DataLoader(TimeScale.day, connector=DataConnectorType.tradier)
...
@pytest.mark.devtest
def no_test_apple_stock_close_price_range_str_minute() -> bool:
    print("no_test_apple_stock_close_price_range_str_minute")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
    last_price_range = dl["AAPL"].close[
...
@pytest.mark.devtest
def no_test_apple_stock_close_price_range_str_minute_int() -> bool:
    print("no_test_apple_stock_close_price_range_str_minute")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
    last_price_range = dl["AAPL"].close[
...
@pytest.mark.devtest
def no_test_apple_stock_price_range_int_minute() -> bool:
    print("no_test_apple_stock_close_price_range_str_minute")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
...
@pytest.mark.devtest
def no_test_apple_stock_price_range_int_day() -> bool:
    print("no_test_apple_stock_price_range_int_day")
    dl = DataLoader(TimeScale.day, connector=DataConnectorType.tradier)
    last_price_range = dl["AAPL"][-5:-1]  # type:ignore
    print(last_price_range)
...
@pytest.mark.devtest
def no_test_apple_stock_price_range_date_day() -> bool:
    print("no_test_apple_stock_price_range_date_day")
    dl = DataLoader(TimeScale.day, connector=DataConnectorType.tradier)
...
@pytest.mark.devtest
def no_test_apple_stock_price_range_date_int_day() -> bool:
    print("no_test_apple_stock_price_range_date_int_day")
    dl = DataLoader(TimeScale.day, connector=DataConnectorType.tradier)
...
@pytest.mark.devtest
def no_test_apple_stock_price_range_date_int_min() -> bool:
    print("no_test_apple_stock_price_range_date_int_min")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
    last_price_range = dl["AAPL"]["2020-10-05":-1]  # type:ignore
    print(last_price_range)
    return True
...
@pytest.mark.devtest
def no_test_apple_stock_price_range_date_int_min_open() -> bool:
    print("no_test_apple_stock_price_range_date_int_min_open")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
...
@pytest.mark.devtest
def no_test_apple_stock_price_open_range_date_int_min_open() -> bool:
    print("no_test_apple_stock_price_close_range_date_int_min_open")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
...
@pytest.mark.devtest
def no_test_apple_stock_price_range_date_min_open() -> bool:
    print("no_test_apple_stock_price_range_date_min_open")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
    try:
...
@pytest.mark.devtest
def no_test_apple_stock_price_open_range_date_min_open() -> bool:
    print("no_test_apple_stock_price_open_range_date_min_open")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
    try:
...
@pytest.mark.devtest
def no_test_apple_stock_price_range_date_min() -> bool:
    print("no_test_apple_stock_price_range_date_min")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
...
@pytest.mark.devtest
def no_test_apple_stock_price_range_date_min_mixed() -> bool:
    print("no_test_apple_stock_price_range_date_min_mixed")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
    d1 = date(year=2021, month=2, day=1)
...
@pytest.mark.devtest
def no_test_apple_stock_price_range_date_day_mixed() -> bool:
    print("no_test_apple_stock_price_range_date_day_mixed")
    dl = DataLoader(TimeScale.day, connector=DataConnectorType.tradier)
    d1 = date(year=2021, month=2, day=1)
...
@pytest.mark.devtest
def no_test_apple_stock_price_open_range_date_min_mixed() -> bool:
    print("no_test_apple_stock_price_range_date_min_mixed")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
...
@pytest.mark.devtest
def no_test_apple_stock_price_open_str() -> bool:
    print("no_test_apple_stock_price_open_str")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
    d1 = date(year=2021, month=2, day=1)
...
@pytest.mark.devtest
def no_test_apple_stock_price_open_date() -> bool:
    print("no_test_apple_stock_price_open_date")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
...
@pytest.mark.devtest
def no_test_get_symbols_tradier() -> bool:
    print("no_test_get_symbols_tradier")
    dl = DataLoader(TimeScale.minute, connector=DataConnectorType.tradier)
